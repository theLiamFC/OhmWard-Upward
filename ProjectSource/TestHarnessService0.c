...
//      puts("\rES_SHORT_TIMEOUT received\r\n");
    ...
    {
//        DB_printf("ES_NEW_KEY received with -> %c <- in Test Service\r\n",(char)ThisEvent.EventParam);
//        if ('1' == ThisEvent.EventParam) //planet
//        {
//            ES_Event_t NewEvent;
//            NewEvent.EventType = ES_PLANET_HIT;
//            NewEvent.EventParam = 0;
//            PostGameService(NewEvent);
//        }
//        if ('2' == ThisEvent.EventParam) //planet
//        {
//            ES_Event_t NewEvent;
//            NewEvent.EventType = ES_PLANET_HIT;
...
//            PostGameService(NewEvent);
//        }
//        if ('3' == ThisEvent.EventParam) //planet
//        {
//            ES_Event_t NewEvent;
//            NewEvent.EventType = ES_PLANET_HIT;
...
//            PostGameService(NewEvent);
//        }
//        if ('4' == ThisEvent.EventParam) //planet
//        {
//            ES_Event_t NewEvent;
//            NewEvent.EventType = ES_PLANET_HIT;
...
//            PostGameService(NewEvent);
//        }
//        if ('a' == ThisEvent.EventParam) //asteroid
//        {
//            ES_Event_t NewEvent;
//            NewEvent.EventType = ES_ASTEROID_HIT;
//            PostGameService(NewEvent);
//        }
//        if('c' == ThisEvent.EventParam){
//            ES_Event_t NewEvent;
//            NewEvent.EventType = ES_COIN_INSERT;
//            PostGameService(NewEvent); 
//        }
//        if('b' == ThisEvent.EventParam){
//            ES_Event_t NewEvent;
//            NewEvent.EventType = ES_BLACKHOLE_HIT;
//            PostGameService(NewEvent);
//        }
//        if('s' == ThisEvent.EventParam){
//            DB_printf("POSTING SHIFT\n");
//            ES_Event_t NewEvent;
//            NewEvent.EventType = ES_UPDATE_SHIFT;
//            PostPerceptionService(NewEvent);
//        }
    }
    break;
    default:
